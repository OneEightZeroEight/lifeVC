...
class Cart extends React.Component{
    ...
    componentDidMount(){
        ...
        React.axios.get('http://marketing.lifevc.com/v1/getCart?si=&ck=11370228_223814890&regionId=16886&pm=8&o=http%3A%2F%2Fm.lifevc.com&NewCartVersion=true')
        .then((res)=>{
            // console.log(res.data.RecommendItems);
            this.setState({
                Bbottom:res.data.RecommendItems
            })
        })
        .catch((err)=>{
            console.log(err);
